...
After running some inference on the merged model to see if the output makes sense, I uploaded the model to HuggingFace Hub per the instructions [here](https://huggingface.co/docs/hub/repositories-getting-started#terminal).
