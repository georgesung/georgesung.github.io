...
## Inference results
To see some ad-hoc inference results I ran, look at this [Colab notebook](https://colab.research.google.com/drive/1IlpeofYD9EU6dNHyKKObZhIzkBMyqlUS?usp=sharing). I used a T4 GPU in Colab to run inference, and I believe the T4 GPU is available in the free version of Google Colab.
